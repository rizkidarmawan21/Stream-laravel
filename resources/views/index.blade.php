...
<body>
    ...
    <header class="text-white bg-stream-dark font-poppins select-none h-full relative">
        ...
        <section class="py-[100px] flex flex-col items-center gap-5 px-3 relative">
            ...
            <a class="mt-5 rounded-full bg-indigo-600 text-center py-3 px-11">
        ...
        <!-- Modal video -->
        <section class="relative bg-yellow-100">
            <div class="max-w-screen hidden h-full mx-auto bg-black bg-opacity-70 fixed z-30 inset-0" id="openStream">
            </div>
            <div class="hidden fixed z-50  mx-auto w-[720px] h-[405px] inset-0 top-[20%]" id="contentOpenStream">
                <video-js class="frame-video overflow-hidden h-[405px] w-full" id="stream-video">
                    <source src="https://d33kv075lir7n3.cloudfront.net/Details+Screen+Part+Final.mp4"
                        type="video/mp4" />
    ...
    <script>
        ...
        videojs('stream-video', {
            ...
            autoplay: false,
            preload: 'auto',
            poster: 'stream/assets/images/poster.png',
        ...
        $("#stream-preview").click(function() {
            ...
            $("#contentOpenStream").removeClass('hidden')
        ...
        $("#openStream").click(function() {
            $("#contentOpenStream").addClass('hidden')
            $('body').removeClass('overflow-y-hidden')
            $("#openStream").addClass('hidden')
            $("#stream-video").addClass('vjs-paused').removeClass('vjs-playing')
        })
    </script>
</body>
